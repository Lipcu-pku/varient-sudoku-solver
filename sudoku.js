...
window.SudokuApp = (function () {
  ...
  function drawCompare() {
    ...
    for (const d of compare) {
      ...
      const rot = angle;
      /* Flatter chevron: smaller half-height narrows the V angle (~108° → ~66°),
         slightly longer wings keep it readable across cell sizes. */
      const h = size * 0.13;   /* half-height of chevron */
      const w = size * 0.20;   /* wing length */
      const g = document.createElementNS('http://www.w3.org/2000/svg', 'g');
